...
class Engine {
    ...
    public Engine(String Engineitems, double Specialid, int cost) {
        this.Engineitems = Engineitems;
        this.Specialid = Specialid;
        this.cost = cost;
    }

    public String getEngineitems() {
        return Engineitems;
    }

    public double getSpecialid() {
        return Specialid;
    }
...
class CombustionEngine extends Engine {
    public CombustionEngine(String Engineitems, double Specialid, int cost) {
        super(Engineitems, Specialid, cost);
    }
}

class ElectricEngine extends Engine {
    public ElectricEngine(String Engineitems, double Specialid, int cost) {
        super(Engineitems, Specialid, cost);
    }
}

class HybridEngine extends Engine {
    public HybridEngine(String Engineitems, double Specialid, int cost) {
        super(Engineitems, Specialid, cost);
    }
}
...
class ICEV extends Vehicle {
    ...
    public void ShowCharacteristics() {
        ...
        System.out.println("Engine Items: " + getEngine().getEngineitems());
        System.out.println("Engine Special ID : " + getEngine().getSpecialid());
